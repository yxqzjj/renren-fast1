...
public class WcsMessageLogService {
     ...
     */
    public void insertIntoWcsMessageLog(String plcName, String msg, Integer type, String reserved1, String reserved2) {
    ...
    public void insertIntoCommandLog(MsgDTO msgDTO) {
        WcsCommandlogEntity commandLog = null;
        if (msgDTO instanceof MsgCycleOrderDTO) {
            commandLog = new WcsCommandlogEntity();
