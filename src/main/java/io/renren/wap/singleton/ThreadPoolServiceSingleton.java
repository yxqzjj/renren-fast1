package io.renren.wap.singleton;
...
public class ThreadPoolServiceSingleton {
    ...
    public ScheduledFuture<?> cyclicExecutingHeartBeatAsk(Runnable runnable) {
        return executorServiceHeartBeatAsk.scheduleAtFixedRate(runnable, SocketClientConstant.AUTO_CONNECTION_INITIAL_DELAY, SystemCache.HEART_BEAT_ASK_TIME, TimeUnit.SECONDS);
    }
    ...
    public ScheduledFuture<?> cyclicExecutingMachineStatus(Runnable runnable) {
        return executorServiceMachineStatusAsk.scheduleAtFixedRate(runnable, SocketClientConstant.AUTO_CONNECTION_INITIAL_DELAY, SystemCache.MACHINE_STATUS_ASK_TIME, TimeUnit.SECONDS);
    }
