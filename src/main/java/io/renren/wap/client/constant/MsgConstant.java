...
public class MsgConstant implements Serializable {
     ...
     * 发送标识
     */
    public static final Integer BYTE_TYPE_SEND = 1;
    /**
     * 接收标识
     */
    public static final Integer BYTE_TYPE_RECEIVE = 2;
    /**
     * 发送标识
     */
     ...
     * 消息报文头部 Integer（开始）
     */
    public static final Integer STX_BYTE = 0x02;
    /**
     * 消息报文尾部 Integer（结束）
     */
    public static final Integer ETX_BYTE = 0x03;
    /**
     * 消息报文头部 Integer（开始）
     */
