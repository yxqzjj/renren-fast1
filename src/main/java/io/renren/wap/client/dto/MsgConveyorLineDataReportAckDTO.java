 ...
 * @Version: V1.0.0
 **/
public class MsgConveyorLineDataReportAckDTO extends MsgDTO {
    /**
     * 数据数量	1-9
     */
    ...
    public byte[] msgDTOToBytes(MsgConveyorLineDataReportAckDTO msgConveyorLineDataReportAckDTO) {
        MsgSendService msgSendService = Objects.requireNonNull(FactoryProducer.getFactory(FactoryConstant.SEND)).getMsgSendService(msgConveyorLineDataReportAckDTO);
        return msgSendService.msgDTOToBytes(msgConveyorLineDataReportAckDTO);
    }
    ...
    public String getData() {
        return dataNum + blockNo + storageNum + mcKey + barcode + loadStatus + cargoHeight + cargoWidth + weight;
    }
