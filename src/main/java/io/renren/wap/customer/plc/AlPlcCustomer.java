 ...
 * @Version: V1.0.0
 **/
public class AlPlcCustomer extends AbstractPlcCustomer {
    public AlPlcCustomer(String plcName) {
        super(plcName);
    }
    ...
    void doMsgMachineryStatusOrderAckDTO(MsgMachineryStatusOrderAckDTO msgMachineryStatusOrderAckDTO) {
        ...
        for (MsgMachineryStatusOrderAckDTO.MachineStatus machineStatus : machineStatusList) {
            ...
            blockService.updateBlockErrorCode(exceptionCode, DbUtil.getALBlockDao(), machineName);
        }
    }
