 ...
 * @Version: V1.0.0
 **/
public class McPlcCustomer extends AbstractPlcCustomer {
    public McPlcCustomer(String plcName) {
        super(plcName);
    }
    ...
    void doMsgMachineryStatusOrderAckDTO(MsgMachineryStatusOrderAckDTO msgMachineryStatusOrderAckDTO) {
        ...
        for (MsgMachineryStatusOrderAckDTO.MachineStatus machineStatus : machineStatusList) {
            ...
            blockService.updateBlockErrorCode(exceptionCode, DbUtil.getMCBlockDao(), machineName);
        }
    }
